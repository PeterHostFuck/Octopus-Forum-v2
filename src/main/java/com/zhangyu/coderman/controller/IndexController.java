...
import com.zhangyu.coderman.myenums.UserType;
import com.zhangyu.coderman.provider.AliYunCodeProivder;
...
public class IndexController {
    ...
    public ResultTypeDTO register(@RequestParam(value = "name") String name,
        ...
        user.setAvatarUrl("http://www.zykcoderman.xyz/images/default/"+(int)(Math.random()*18+1)+".png");
        user.setAccountId(phone);
